...
ruleTester.run("keyword-spacing", rule, {
    valid: [
        ...
        { code: "<Foo onClick={async function foo() {}} />", languageOptions: { ecmaVersion: 8, ecmaFeatures: { jsx: true } } },
        { code: "<Foo onClick={ async function foo() {}} />", options: [NEITHER], languageOptions: { ecmaVersion: 8, ecmaFeatures: { jsx: true } } },
        ...
        // not conflict with `jsx-curly-spacing`
        { code: "async function wrap() { <Foo onClick={await a} /> }", languageOptions: { ecmaVersion: 8, ecmaFeatures: { jsx: true } } },
        { code: "async function wrap() { <Foo onClick={ await a} /> }", options: [NEITHER], languageOptions: { ecmaVersion: 8, ecmaFeatures: { jsx: true } } },
        ...
        // not conflict with `jsx-curly-spacing`
        { code: "<Foo onClick={class {}} />", languageOptions: { ecmaVersion: 6, ecmaFeatures: { jsx: true } } },
        { code: "<Foo onClick={ class{}} />", options: [NEITHER], languageOptions: { ecmaVersion: 6, ecmaFeatures: { jsx: true } } },
        ...
        // not conflict with `jsx-curly-spacing`
        { code: "class A extends B { constructor() { <Foo onClick={super()} /> } }", languageOptions: { ecmaVersion: 6, ecmaFeatures: { jsx: true } } },
        { code: "class A extends B { constructor() { <Foo onClick={ super() } /> } }", options: [NEITHER], languageOptions: { ecmaVersion: 6, ecmaFeatures: { jsx: true } } },
        ...
        // not conflict with `jsx-curly-spacing`
        { code: "function* foo() { <Foo onClick={yield} /> }", languageOptions: { ecmaVersion: 6, ecmaFeatures: { jsx: true } } },
        { code: "function* foo() { <Foo onClick={ yield } /> }", options: [NEITHER], languageOptions: { ecmaVersion: 6, ecmaFeatures: { jsx: true } } },

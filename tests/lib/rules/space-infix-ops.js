...
ruleTester.run("space-infix-ops", rule, {
    valid: [
        ...
        "a ? b : c",
        "var a = b",
        { code: "const my_object = {key: 'value'};", languageOptions: { ecmaVersion: 6 } },
        { code: "var {a = 0} = bar;", languageOptions: { ecmaVersion: 6 } },
        { code: "function foo(a = 0) { }", languageOptions: { ecmaVersion: 6 } },
        { code: "a ** b", languageOptions: { ecmaVersion: 7 } },
        { code: "a|0", options: [{ int32Hint: true }] },
        { code: "a |0", options: [{ int32Hint: true }] },

        // Type Annotations
        { code: "function foo(a: number = 0) { }", parser: parser("type-annotations/function-parameter-type-annotation"), languageOptions: { ecmaVersion: 6 } },
        { code: "function foo(): Bar { }", parser: parser("type-annotations/function-return-type-annotation"), languageOptions: { ecmaVersion: 6 } },
        { code: "var foo: Bar = '';", parser: parser("type-annotations/variable-declaration-init-type-annotation"), languageOptions: { ecmaVersion: 6 } },
        { code: "const foo = function(a: number = 0): Bar { };", parser: parser("type-annotations/function-expression-type-annotation"), languageOptions: { ecmaVersion: 6 } },

        // TypeScript Type Aliases
        { code: "type Foo<T> = T;", parser: parser("typescript-parsers/type-alias"), languageOptions: { ecmaVersion: 6 } },

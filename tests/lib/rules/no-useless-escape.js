...
ruleTester.run("no-useless-escape", rule, {
    valid: [
        ...
        "var foo = '\\\n';",
        "var foo = '\\\r\n';",
        { code: "<foo attr=\"\\d\"/>", languageOptions: { ecmaFeatures: { jsx: true } } },
        { code: "<div> Testing: \\ </div>", languageOptions: { ecmaFeatures: { jsx: true } } },
        { code: "<div> Testing: &#x5C </div>", languageOptions: { ecmaFeatures: { jsx: true } } },
        { code: "<foo attr='\\d'></foo>", languageOptions: { ecmaFeatures: { jsx: true } } },
        { code: "<> Testing: \\ </>", languageOptions: { ecmaFeatures: { jsx: true } } },
        { code: "<> Testing: &#x5C </>", languageOptions: { ecmaFeatures: { jsx: true } } },
